...
@section('content')
    ...
    <section class="section" style="padding-top: 0;">
        <div class="container">
            <div class="about-leadership-grid" style="background: var(--bg-card); border: 1px solid var(--border-active); border-radius: var(--radius-lg); padding: 48px; align-items: center; margin-bottom: 60px;">
                ...
                <div>
                    ...
                    <h2 class="leadership-title">«Մենք չենք ստեղծում պարզապես կայքեր, մենք կառուցում ենք վաճառքի հզոր գործիքներ»</h2>
